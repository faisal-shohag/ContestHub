    ...
    <div className="w-full border p-10 rounded-lg mt-20">
      ...
      <div className="flex lg:flex flex-col lg:flex-row justify-between w-full lg:pl-10 md:pl-10 font-philo">
        <div className="grid md:grid-cols-3 md:gap-20 lg:gap-20 gap-5 place-content-center text-center md:text-left lg:text-left">
          <div>
            <div className="font-medium text-red-500">Site Map</div>
          ...
          <div>
            <div className="font-medium text-red-500">Service</div>
            <ul className="text-sm">
              <li>
                <Link to="/">Agents</Link>
              </li>
          ...
          <div>
            <div className="font-medium text-red-500">Resources</div>
            <ul className="text-sm">
              <li>
        ...
        <div className="lg:block md:block hidden">
          <div className="lg:bg-red-200 md:bg-red-200 flex rounded-full  lg:flex-row md:flex-row flex-col mt-10 justify-between dark:bg-gray-600 shadow-md">
            <input
              type="text"
              name="email"
              placeholder="Email"
              className="input focus:outline-none border-none  rounded-full pl-6 text-black bg-red-200 dark:bg-gray-600 py-2"
              required
            />
            <button className="bg-red-500 px-5   rounded-full lg:mt-0 md:mt-0 mt-2 py-2 shadow-xl text-white">Subscribe</button>
          </div>
          </div>
